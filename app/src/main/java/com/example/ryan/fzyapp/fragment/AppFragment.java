...
public class AppFragment extends BaseFragment<AndroidPresenter> implements AndroidView{
    public static AppFragment appInstance ;
    ...
    public void initData() {
        androidPresenter.loadAndroid("App","10","1");
    }
