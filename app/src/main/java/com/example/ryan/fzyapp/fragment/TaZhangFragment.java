...
public class TaZhangFragment extends BaseFragment<AndroidPresenter> implements AndroidView{
    public static TaZhangFragment appInstance ;
    ...
    public static TaZhangFragment newInstance() {
        if (appInstance == null) {
            appInstance = new TaZhangFragment();
        }
        return appInstance;
    }
    ...
    public void initData() {
        androidPresenter.loadAndroid("拓展资源","10","1");
    }
