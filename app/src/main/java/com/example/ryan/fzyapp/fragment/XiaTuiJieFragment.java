...
public class XiaTuiJieFragment extends BaseFragment<AndroidPresenter> implements AndroidView {

    public static XiaTuiJieFragment androidInstance ;
    ...
    public static XiaTuiJieFragment newInstance() {
        if (androidInstance == null) {
            androidInstance = new XiaTuiJieFragment();
        }
    ...
    public void initData() {
        androidPresenter.loadAndroid("瞎推荐","10","1");
    }
