...
public class QianDuanFragment extends BaseFragment<AndroidPresenter> implements AndroidView {

    public static QianDuanFragment androidInstance ;
    ...
    public static QianDuanFragment newInstance() {
        if (androidInstance == null) {
            androidInstance = new QianDuanFragment();
        }
    ...
    public void initData() {
        androidPresenter.loadAndroid("前端","10","1");
    }
