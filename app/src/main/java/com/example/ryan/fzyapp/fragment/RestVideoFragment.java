...
public class RestVideoFragment extends BaseFragment<AndroidPresenter> implements AndroidView {

    public static RestVideoFragment androidInstance ;
    ...
    public static RestVideoFragment newInstance() {
        if (androidInstance == null) {
            androidInstance = new RestVideoFragment();
        }
    ...
    public void initData() {
        androidPresenter.loadAndroid("休息视频","10","1");
    }
